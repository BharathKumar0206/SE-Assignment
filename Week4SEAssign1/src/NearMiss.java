 ...
 * 
 * Programmers' Names: 
 * 1. Bharath Kumar Pola - BharathKumarPola@lewisu.edu
 * 2. Tarun Singu - TarunSingu@lewisu.edu
 * 
 * Course: FA24-CPSC-60500-001
 * 
...
public class NearMiss {
	...
	{ 
	  ...
	  //do while loop to make sure user enters valid input
	    ...
	    System.out.println("|| x ==> "+ x1 +" || y ==> "+ y1 +" ||  Relative Difference ==> " + String.format("%.7f", smallestmiss) + " ||");
	}
}
